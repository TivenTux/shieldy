...
Пожалуйста, нажмите на кнопку ниже в течение указанного времени, иначе вы будете кикнуты. Спасибо!`,
    en:
      ', Hello ! This is our human detector bot. Please press the button below within the time ammount specified to avoid getting banned!',
    ru:
      ', пожалуйста, нажмите на кнопку ниже в течение указанного времени, иначе вы будете кикнуты. Спасибо!',
    it:
  ...
  captcha_button: {
    ...
    en: 'Πατήστε ΕΔΩ για είσοδο / Press HERE to enter',
    ru: 'Я не бот',
    it: 'Non sono un bot',
    et: 'Ma ei ole bot',
    uk: 'Я не бот',
